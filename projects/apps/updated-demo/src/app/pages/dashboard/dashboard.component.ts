...
@Component({
  ...
  styles: [
    `
      ...
      .feature-icon-wrap--flex {
        background: #1e88e5;
      }
      .feature-icon-wrap--grid {
        background: #43a047;
      }
      .feature-icon-wrap--resp {
        background: #fb8c00;
      }
      .feature-icon-wrap--extra {
        background: #8b32b9;
      }
  ...
  readonly features: Feature[] = [
    {
      ...
      description:
        'Control direction, alignment, wrapping and spacing with intuitive flex directives.',
    ...
    },
    {
      ...
      title: 'CSS Grid',
      description:
        'Build two-dimensional layouts with named areas, columns, rows and gap control.',
    ...
    },
    {
      ...
      title: 'Responsive',
      description:
        'Adapt any directive to a breakpoint with xs / sm / md / lg / xl suffix aliases.',
    ...
    },
    {
      ...
      description:
        'Holy Grail, column ordering, grid spans and more — curated from real questions.',
